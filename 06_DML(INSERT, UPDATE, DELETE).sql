...
-- INSERT INTO EMPLOYEE2 VALUES( 14개의 컬럼값 순서대로 작성해야 함 );
INSERT INTO EMPLOYEE2 VALUES( 900, '장채현', '901123-2345678', 
'jang_ch@kh.or.kr', '01012341234','D1', 'J7', 'S3', 4300000,
...
/* 작성한 컬럼 순서대로 VALUES에 값을 작성해야 한다! */
...
JOIN DEPARTMENT2 ON (DEPT_CODE = DEPT_ID)
JOIN LOCATION    ON (LOCATION_ID = LOCAL_CODE)
WHERE LOCAL_NAME LIKE 'ASIA%'; -- 0.3으로 바뀜
