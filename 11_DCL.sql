...
-- 테이블 생성 권한 없음 + 테이블을 만들 공간을 할당 못받음
...
WHERE ROLE ='CONNECT'; --2개

SELECT * FROM ROLE_SYS_PRIVS
WHERE ROLE ='RESOURCE'; --8개


--TEST_USER 계정에 CONNECT, RESOURCE 롤 부여하기
GRANT CONNECT, RESOURCE TO TEST_USER; --10개의 권한 부여
...
-- KH 계정의 EMPLOYEE 테이블 조회하기
SELECT * FROM KH_LHJ.EMPLOYEE;
 --> 접근 권한이 없어서 보이지 않음
